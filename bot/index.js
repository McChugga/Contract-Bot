    ...
    components = [
      new ActionRowBuilder().addComponents(
        new RoleSelectMenuBuilder()
          ...
          .setPlaceholder("Select ANY roles that can accept contracts")
          .setMinValues(0)
          .setMaxValues(25)
          .setDefaultRoles(...p.approverRoles.slice(0, 25))
      ),
      new ActionRowBuilder().addComponents(
        new UserSelectMenuBuilder()
          .setCustomId("config_approver_members")
          .setPlaceholder("Select individual acceptor members")
          .setMinValues(0)
          .setMaxValues(25)
      ),
      new ActionRowBuilder().addComponents(
        new RoleSelectMenuBuilder()
          ...
          .setPlaceholder("Select ANY roles that can confirm payment")
          .setMinValues(0)
          .setMaxValues(25)
          .setDefaultRoles(...p.paymentRoles.slice(0, 25))
      ),
      new ActionRowBuilder().addComponents(
        new UserSelectMenuBuilder()
          .setCustomId("config_payment_members")
          .setPlaceholder("Select individual payment-confirmers")
          .setMinValues(0)
          .setMaxValues(25)
      ),
      new ActionRowBuilder().addComponents(
