...
async function buildSetupPanel(guildId) {
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      "Choose any server roles that can accept contracts or confirm payments, plus the channels Contract Bot should use. " +
      "Your currently configured roles are pre-selected."
    )
    .addFields(
  ...
  const components = [
    new ActionRowBuilder().addComponents(
      new RoleSelectMenuBuilder()
        ...
        .setMinValues(0)
        .setMaxValues(25)
        .setDefaultRoles(...approverRoles.slice(0, 25))
    ),
    new ActionRowBuilder().addComponents(
      new RoleSelectMenuBuilder()
        ...
        .setMinValues(0)
        .setMaxValues(25)
        .setDefaultRoles(...paymentRoles.slice(0, 25))
    ),
    new ActionRowBuilder().addComponents(
